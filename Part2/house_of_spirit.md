...
as the binary contains no pie, and we got a free heap and libc leak, we can forge a fake chunk with valid fake fd and bk and link it against the small bin